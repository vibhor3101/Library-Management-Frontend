...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      //embedded.books is used as when u will fire the url u will see all the details are stored in embedded
      ...
      <div className="container">
        <div>
          ...
          {totalAmountOfBooks > 0 ? (
            <>
              <div className="mt-3">
                <h5>Numer of results:({totalAmountOfBooks})</h5>
              </div>
              <p>
